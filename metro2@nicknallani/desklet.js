...
MetroDesklet.prototype = {
	...
	this.settings.bindProperty(Settings.BindingDirection.IN, "issinglecol" , "issinglecol" , this.on_setting_changed);

	this.settings.bindProperty(Settings.BindingDirection.IN, "widgetbrdr" , "widgetbrdr" , this.on_setting_changed);
	this.settings.bindProperty(Settings.BindingDirection.IN, "widgetbrdrcolor" , "widgetbrdrcolor" , this.on_setting_changed);
	
	this.settings.bindProperty(Settings.BindingDirection.IN, "widgetbrdrradius" , "widgetbrdrradius" , this.on_setting_changed);
	...
	refreshDecoration: function() {
        ...
        this._container.set_style("background-color:"+this.bgcolor+";border:"+this.widgetbrdr+"px "+this.widgetbrdrcolor+" solid; -moz-border-radius:"+this.widgetbrdrradius+"px "+this.widgetbrdrradius+"px 0 "+this.widgetbrdrradius+"px;-webkit-border-radius:"+this.widgetbrdrradius+"px "+this.widgetbrdrradius+"px 0 "+this.widgetbrdrradius+"px;border-radius:"+this.widgetbrdrradius+"px "+this.widgetbrdrradius+"px 0 "+this.widgetbrdrradius+"px;");
        
        this._row1 = new St.BoxLayout({style_class: "RowContainer"});
        this._row2 = new St.BoxLayout({style_class: "RowContainer"});
                this._row3 = new St.BoxLayout({style_class: "RowContainer"});
                this._row4 = new St.BoxLayout({style_class: "RowContainer"});


        this._title1 = new St.Label();
        this._title2 = new St.Label();
        this._title3 = new St.Label();
        this._title4 = new St.Label();
        ...
        if(this.showtitlebar){
         ...
         if(this.showtitlebaricon){
           this._label    = new St.Label({style_class: "DeskletTitle"});
           this._labelimg = new St.Label({style_class: "ButtonMove"});
            if(this.titletext==""){
                //do nothing
            }else{
        ...
        if(this.showtitlebaricon){this._container.add(this._labelimg);}
        this._container.add(this._label);        
      }   

       if(this.stylestr == "stylesheet"){
           this._btn1 = new St.Button({style_class: "ButtonOne image1"});
           this._btn2 = new St.Button({style_class: "ButtonTwo image2"});
           this._btn3 = new St.Button({style_class: "ButtonThree image3"});
           this._btn4 = new St.Button({style_class: "ButtonFour image4"});
       }
        ...
        var stl="height:"+this.height+"px;width:"+this.width+"px; background-color:"+this.bg1+";-moz-border-radius:"+this.radius+"px "+this.radius+"px "+this.radius+"px "+this.radius+"px;-webkit-border-radius:"+this.radius+"px "+this.radius+"px "+this.radius+"px "+this.radius+"px;border-radius:"+this.radius+"px "+this.radius+"px "+this.radius+"px "+this.radius+"px;display:inline-block;padding:"+this.padding+"px; border:"+this.btnbrdrwdt+"px solid "+this.btnbrdrclr+";	background-position: 15px 15px; background-size: 32px 32px; margin-bottom: 5px;	margin-right: 5px;cursor:pointer;";
    ...
    if(this.issinglecol){
        ...
        this._row2.add(this._btn2);
        this._row3.add(this._btn3);
        this._row4.add(this._btn4);
        this._container.add(this._row1);
        this._container.add(this._row2);
        this._container.add(this._row3);
        this._container.add(this._row4);
    }
    else{
    ...
    _btn4ClickAction: function () {
        Util.spawnCommandLine(this.appCmd4);
    }
}
