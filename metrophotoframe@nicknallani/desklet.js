...
class CinnamonPhotoFrameDesklet extends Desklet.Desklet {
    ...
    this.settings.bind( "bg-color"     , "bgcolor"    , this.on_setting_changed);
    this.settings.bind( "fheight"       , "fheight"     , this.on_setting_changed);
    this.settings.bind( "fwidth"        , "fwidth"      , this.on_setting_changed);
	this.settings.bind( "btn-brdr-clr" , "btnbrdrclr" , this.on_setting_changed);
	this.settings.bind( "btn-brdr-wdt" , "btnbrdrwdt" , this.on_setting_changed);
    this.settings.bind( "radius"       , "radius"     , this.on_setting_changed);
	this.settings.bind( "padding"      , "padding"    , this.on_setting_changed);
    ...
    setup_display() {
        this._photoFrame = new St.Bin();
this._photoFrame.style = "background-color:"+this.bgcolor+";height:"+this.fheight+"px;width:"+this.fwidth+"px;border:"+this.btnbrdrwdt+"px solid "+this.btnbrdrclr+";-moz-border-radius:"+this.radius+"px "+this.radius+"px "+this.radius+"px "+this.radius+"px;-webkit-border-radius:"+this.radius+"px "+this.radius+"px "+this.radius+"px "+this.radius+"px;border-radius:"+this.radius+"px "+this.radius+"px "+this.radius+"px "+this.radius+"px;display:inline-block;padding:"+this.padding+"px;";


//linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(9,70,121,0.8855917366946778) 24%, rgba(0,212,255,1) 100%);

        this._bin = new St.Bin();
//this._bin.style = "background-color:rgba(126,126,126,0.8);height:"+this.height+"px;width:"+this.width+"px;border-style: inset;border:"+this.btnbrdrwdt+"px solid "+this.btnbrdrclr+";-moz-border-radius:"+this.radius+"px "+this.radius+"px "+this.radius+"px "+this.radius+"px;-webkit-border-radius:"+this.radius+"px "+this.radius+"px "+this.radius+"px "+this.radius+"px;border-radius:"+this.radius+"px "+this.radius+"px "+this.radius+"px "+this.radius+"px;display:inline-block;padding:"+this.padding+"px;";        
